...
export default function CreatePropriedades() {
  ...
  const validateForm = (): boolean => {
    ...
    if (files.length === 0) newErrors.pictures = "Envie ao menos uma foto";
    setErrors(newErrors);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.comodities.forEach((c) => data.append("comodities", c));
      data.append("price", String(parseMoney(formData.price)));
      data.append("capacity", String(formData.capacity));
      files.forEach((file) => data.append("pictures", file));

      await catalogoClient.post("/catalogo", data, {
        headers: { "Content-Type": "multipart/form-data" },
      });

      setApiAlert({ message: "Sala criada!", type: "success" });
      ...
      const msg =
        axiosErr?.response?.data && typeof axiosErr.response.data === "object"
          ...
          : "Erro desconhecido";
      setApiAlert({ message: "ERRO: " + msg, type: "error" });
    }
  };
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <Commodities
                      selectedQualities={formData.comodities}
                  ...
                  {imagePreviews.length === 0 ? (
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M4 16l4.586-4.586a2 2 0 012.828 0L16	16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12	a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2	2v12a2 2 0 002 2z"
                            />
                          </svg>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <PhotoGallery photos={imagePreviews} link={false}/>
                      </div>
                    </div>
                  )}
